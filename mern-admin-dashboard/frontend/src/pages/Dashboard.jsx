  ...
  return (
    <div className="dashboard">
      ...
      <div className="cards-grid">
        <SummaryCard title="Total Users" value={stats.totalUsers} change="+12%" icon={<FaUser />} />
        <SummaryCard title="Active Users" value={stats.activeUsers} sub="Last 30 days" icon={<FaChartLine />} />
        <SummaryCard title="Videos Uploaded" value={stats.videosUploaded} change="+8%" icon={<FaVideo />} />
        <SummaryCard title="Total Revenue" value={`$${stats.totalRevenue.toLocaleString()}`} change="+20%" icon={<FaDollarSign />} />
      </div>
